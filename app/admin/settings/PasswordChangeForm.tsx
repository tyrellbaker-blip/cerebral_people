...
interface PasswordChangeFormProps {
  changePasswordAction: (prevState: any, formData: FormData) => Promise<{ error?: string; success?: string } | void>;
}

export default function PasswordChangeForm({ changePasswordAction }: PasswordChangeFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-ink-500">Must be at least 8 characters long</p>
      </div>
