...
CREATE TABLE verification_requests (
  ...
  notes TEXT,
  "adminNotes" TEXT,
  source JSONB, -- Stores NPI lookup results and other verification data
  "reviewedBy" TEXT, -- Admin username who reviewed
  "reviewedAt" TIMESTAMP(3),
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

  CONSTRAINT verification_requests_user_unique UNIQUE ("userId")
);
